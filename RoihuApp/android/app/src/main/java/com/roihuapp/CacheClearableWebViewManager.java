...
public class CacheClearableWebViewManager extends SimpleViewManager<WebView> {
  ...
  public CacheClearableWebViewManager() {
  ...
  public CacheClearableWebViewManager(WebViewConfig webViewConfig) {
  ...
  @ReactProp(name = "clearCache", defaultBoolean = false)
  public void clearCache(WebView view, boolean includeDiskFiles) {
